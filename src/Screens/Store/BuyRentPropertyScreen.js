...
const BuyRentPropertyScreen = ({route, navigation}) => {
  ...
  const [filterData] = useState([
    {
      ...
      data: [
        ...
        {id: 7, title: '10000000-15000000', value: '10000000-15000000'},
        {id: 8, title: '15000000-20000000', value: '15000000-20000000'},
      ],
    },
    {
      id: 2,
  ...
  const renderItem = (val, index) => {
    ...
    if (val && val.features && Array.isArray(val.features)) {
      val.features.forEach(feature => {
        ...
        if (feature?.title?.toLowerCase() === 'furnish_status') {
          furnish_status = feature.value;
        }
      });
    }
    return (
      <View
        ...
        <View
          ...
          <View style={{padding: 5, flex: 1, marginHorizontal: 5}}>
            ...
            {val?.property_action != 'sell' && val?.token_amount !== null && (
              <View style={{}}>
                <Text
                  style={{
                    fontSize: 14,
              ...
              {val?.property_action == 'sell'
                ...
                : val?.features != undefined && (
                    <Text
                      ...
                      {`${baths} bath - ${common_fn.formatText(
                        furnish_status,
                      )}`}
                    </Text>
                  )}
        ...
        <>
          ...
          <View
            ...
            <Text
              ...
              {countFilter ?? 0} results | Properties for {property_type} in{' '}
              {location}
            </Text>
          </View>
          <FlatList
          ...
          {/* <Animated.View
            ...
            <Button
              title={'Clear Search'}
              titleStyle={{color: Color.primary, fontFamily: Poppins.Medium}}
              buttonStyle={{
                backgroundColor: Color.white,
                borderWidth: 1,
            ...
            <Button
              ...
              onPress={() => {
                dispatch(
                  setPropertySavedFilter({
                    buySaved: {
                      AddFilter: AddFilter,
                      filterBuyData: filterBuyData,
                      filterBoolean: true,
                    },
                  }),
                );
...
export default BuyRentPropertyScreen;
//buyScreen
