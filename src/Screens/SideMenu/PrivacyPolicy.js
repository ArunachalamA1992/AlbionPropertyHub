        ...
        try {
            return (
                <View style={{ width: '100%', alignItems: 'center' }}>
                    ...
                    <View style={{ width: '100%', padding: 10 }}>
                        <Text style={{ width: '100%', fontSize: 16, color: '#333', fontFamily: 'Poppins-Bold', textAlign: 'justify', lineHeight: 20 }}>How Collected Data Is Used?</Text>
                        <Text style={{ width: '100%', fontSize: 15, color: '#666', fontFamily: 'Poppins-Regular', textAlign: 'justify', lineHeight: 20, paddingVertical: 10 }}>Third-party advertising companies may serve ads when visiting or using Sites or Services, using information to provide relevant advertisements.</Text>
                    </View>

                    <View style={{ width: '100%', padding: 10 }}>
                        <Text style={{ width: '100%', fontSize: 16, color: '#333', fontFamily: 'Poppins-Bold', textAlign: 'justify', lineHeight: 20 }}>Information Sharing : </Text>
                        <Text style={{ width: '100%', fontSize: 15, color: '#666', fontFamily: 'Poppins-Regular', textAlign: 'justify', lineHeight: 20, paddingVertical: 10 }}>Personal information may be shared to conduct business, within group companies, or with third parties for various purposes outlined in the Policy.</Text>
                    </View>

                    <View style={{ width: '100%', padding: 10 }}>
                        <Text style={{ width: '100%', fontSize: 16, color: '#333', fontFamily: 'Poppins-Bold', textAlign: 'justify', lineHeight: 20 }}>Accessing and Updating Personal Information: </Text>
                        <Text style={{ width: '100%', fontSize: 15, color: '#666', fontFamily: 'Poppins-Regular', textAlign: 'justify', lineHeight: 20, paddingVertical: 10 }}>Users can access and update personal information, and the Company makes efforts to correct inaccuracies, subject to legal requirements.</Text>
                    </View>

                    <View style={{ width: '100%', padding: 10 }}>
                        <Text style={{ width: '100%', fontSize: 16, color: '#333', fontFamily: 'Poppins-Bold', textAlign: 'justify', lineHeight: 20 }}>Information Security :</Text>
                        <Text style={{ width: '100%', fontSize: 15, color: '#666', fontFamily: 'Poppins-Regular', textAlign: 'justify', lineHeight: 20, paddingVertical: 10 }}>Appropriate security measures are implemented to protect data against unauthorized access, alteration, disclosure, or destruction.</Text>
                    </View>
                    <View style={{ width: '100%', padding: 10 }}>
                        <Text style={{ width: '100%', fontSize: 16, color: '#333', fontFamily: 'Poppins-Bold', textAlign: 'justify', lineHeight: 20 }}>Updates / Changes :</Text>
                        <Text style={{ width: '100%', fontSize: 15, color: '#666', fontFamily: 'Poppins-Regular', textAlign: 'justify', lineHeight: 20, paddingVertical: 10 }}>The Policy may be modified to incorporate changes in technology or applicable law. Changes become effective immediately upon notice, posted on the Sites.</Text>
                    </View>

                    <View style={{ width: '100%', padding: 10 }}>
                        <Text style={{ width: '100%', fontSize: 16, color: '#333', fontFamily: 'Poppins-Bold', textAlign: 'justify', lineHeight: 20 }}>Security : </Text>
                        <Text style={{ width: '100%', fontSize: 15, color: '#666', fontFamily: 'Poppins-Regular', textAlign: 'justify', lineHeight: 20, paddingVertical: 10 }}>Commercially reasonable security measures are in place, but absolute protection is not guaranteed.</Text>
                    </View>

                    <View style={{ width: '100%', padding: 10 }}>
                        <Text style={{ width: '100%', fontSize: 16, color: '#333', fontFamily: 'Poppins-Bold', textAlign: 'justify', lineHeight: 20 }}>Accuracy and Confidentiality of Account Information : </Text>
                        <Text style={{ width: '100%', fontSize: 15, color: '#666', fontFamily: 'Poppins-Regular', textAlign: 'justify', lineHeight: 20, paddingVertical: 10 }}>Customers are responsible for maintaining accurate and confidential account information.</Text>
                    </View>

                    <View style={{ width: '100%', padding: 10 }}>
                        <Text style={{ width: '100%', fontSize: 16, color: '#333', fontFamily: 'Poppins-Bold', textAlign: 'justify', lineHeight: 20 }}>Third-Party Websites :</Text>
                        <Text style={{ width: '100%', fontSize: 15, color: '#666', fontFamily: 'Poppins-Regular', textAlign: 'justify', lineHeight: 20, paddingVertical: 10 }}>The Company is not liable for the misuse of information by third-party websites linked on the Site.</Text>
                    </View>

                    <View style={{ width: '100%', padding: 10 }}>
                        <Text style={{ width: '100%', fontSize: 16, color: '#333', fontFamily: 'Poppins-Bold', textAlign: 'justify', lineHeight: 20 }}>Questions / Grievance Redressal : </Text>
                        <Text style={{ width: '100%', fontSize: 15, color: '#666', fontFamily: 'Poppins-Regular', textAlign: 'justify', lineHeight: 20, paddingVertical: 10 }}>Users may address concerns or grievances to the designated Grievance Officers, whose contact information is provided in the Terms of Use.</Text>
                    </View>

                    <View style={{ width: '100%', padding: 10, marginVertical: 10 }}>
                        <Text style={{ width: '100%', fontSize: 16, color: '#333', fontFamily: 'Poppins-Bold', textAlign: 'justify', lineHeight: 20 }}>How We Use Your Information</Text>
                        <Text style={{ width: '100%', fontSize: 15, color: '#666', fontFamily: 'Poppins-Regular', textAlign: 'justify', lineHeight: 20, paddingVertical: 10 }}>We use the information that we collect about you or that you provide to us, including any personal information, to:</Text>
                        ...
                        <View style={{ width: '100%', paddingVertical: 0, padding: 10 }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                ...
                                <Text style={{ fontSize: 16, color: '#000', textAlign: 'justify', marginHorizontal: 10, fontFamily: 'Poppins-SemiBold', }}>Present our Service and its contents to you.</Text>
                            </View>
                        </View>
                        ...
                        <View style={{ width: '100%', paddingVertical: 0, padding: 10 }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <View style={{ width: 5, height: 5, backgroundColor: '#666', borderRadius: 50 }}></View>
                                <Text style={{ fontSize: 16, color: '#000', textAlign: 'justify', marginHorizontal: 10, fontFamily: 'Poppins-SemiBold', }}>Provide you with information or services that you request from us</Text>
                            </View>
                        </View>
                        ...
                        <View style={{ width: '100%', paddingVertical: 0, padding: 10 }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <View style={{ width: 5, height: 5, backgroundColor: '#666', borderRadius: 50 }}></View>
                                <Text style={{ fontSize: 16, color: '#000', textAlign: 'justify', marginHorizontal: 10, fontFamily: 'Poppins-SemiBold', }}>Fulfill any other purpose for which you provide it.</Text>
                            </View>
                        </View>
                        ...
                        <View style={{ width: '100%', paddingVertical: 0, padding: 10 }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <View style={{ width: 5, height: 5, backgroundColor: '#666', borderRadius: 50 }}></View>
                                <Text style={{ fontSize: 16, color: '#000', textAlign: 'justify', marginHorizontal: 10, fontFamily: 'Poppins-SemiBold', }}>Notify you when updates are available and of changes to any products or services we offer.</Text>
                            </View>
                        </View>

                        <Text style={{ width: '100%', fontSize: 15, color: '#666', fontFamily: 'Poppins-Regular', textAlign: 'justify', lineHeight: 20, paddingVertical: 10 }}>We may also use your information to contact you about our own and third-parties goods and services that may be of interest to you</Text>

                    </View>

                    <View style={{ width: '100%', padding: 10 }}>
                        <Text style={{ width: '100%', fontSize: 18, color: 'black', fontFamily: 'Poppins-Bold' }}>Data Security</Text>
                        <Text style={{ width: '100%', fontSize: 15, color: '#666', fontFamily: 'Poppins-Regular', textAlign: 'justify', lineHeight: 20, paddingVertical: 10 }}>We have implemented measures designed to secure your personal information from accidental loss and from unauthorized access, use, alteration, and disclosure. All information you provide to us is stored on our secure servers behind firewalls.</Text>
                    </View>

                    <View style={{ width: '100%', padding: 10 }}>
                        <Text style={{ width: '100%', fontSize: 18, color: 'black', fontFamily: 'Poppins-Bold' }}>Changes to Our Privacy Policy</Text>
                        <Text style={{ width: '100%', fontSize: 15, color: '#666', fontFamily: 'Poppins-Regular', textAlign: 'justify', lineHeight: 20, paddingVertical: 10 }}>It is our policy to post any changes we make to our privacy policy on this page. If we make material changes to how we treat our users' personal information, we will notify you through a notice on the Service. The date the privacy policy was last revised is identified at the top of the page.</Text>
                    </View>
